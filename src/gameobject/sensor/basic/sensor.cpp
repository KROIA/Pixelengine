...
{
    GAME_OBJECT_FUNCTION(profiler::colors::Yellow);
...
{
    GAME_OBJECT_FUNCTION(profiler::colors::Yellow100);
...
{
    GAME_OBJECT_FUNCTION(profiler::colors::Yellow200);
...
{
    GAME_OBJECT_FUNCTION(profiler::colors::Yellow300);
...
void Sensor::setVisibility_collider_boundingBox(bool isVisible)
{
    m_visibility_collider_boundingBox = isVisible;
}
bool Sensor::isVisible_collider_boundingBox() const
{
